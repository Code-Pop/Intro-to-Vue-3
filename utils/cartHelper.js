...
export function createShoppingCart() {
  ...
  function removeItemFromTheShoppingCart(indexOfItemToRemove) {
    ...
    const theItemThatIsBeingRemoved =
      theShoppingCartObject.theArrayOfCartItems[indexOfItemToRemove]
